    ...
    with make_carla_client(args.host, args.port) as client:
        ...
        for episode in range(0, number_of_episodes):
            ...
            if args.settings_filepath is None:
                ...
                if args.semantic:
                    semcamera = Camera('SemanticSegmentation', PostProcessing='SemanticSegmentation')
...
def print_measurements(measurements):
    ...
    # Custom ai_control
    message += 'throttle={autopilot_throttle}, '
    message += 'steer={autopilot_steer}'
    message = message.format(
        ...
        autopilot_throttle=player_measurements.autopilot_control.throttle,
        autopilot_steer=player_measurements.autopilot_control.steer)
    
    # print_over_same_line(message)

    # print("player_measurements.acceleration:",player_measurements.acceleration)
    # print("player_measurements.autopilot_control:",player_measurements.autopilot_control)
